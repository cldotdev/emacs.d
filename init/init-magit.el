...
;; Verify the GPG signature by default in the revision buffer, which prints the
;; gpg verdict above the diff.  Not in the log, where verification runs gpg
;; once per signed commit and noticeably slows opening it.
